...
| `DISCORD_AUTO_THREAD_NAME_MODE` | Auto-thread naming mode: `summary` (default, rename to generated session title) or `message` (keep message-derived name) |
| `DISCORD_AUTO_THREAD_SUMMARY_MAX_CHARS` | Maximum characters for summary-generated Discord auto-thread names (default: `70`, capped at Discord's 100-character limit) |
